...
var login = function login(el) {
  ...
  document.getElementById('signup-up--login-box').addEventListener('click', function () {
    history.pushState('signup', null, window.location.pathname + '?signup=1'); // redirect(`${window.location.pathname}index.html?signup=1`)
